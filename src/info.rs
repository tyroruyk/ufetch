#[path = "modules/cpu.rs"] mod cpu;
#[path = "modules/de.rs"] mod de;
#[path = "modules/os.rs"] mod os;
#[path = "modules/host.rs"] mod host;
#[path = "modules/pkg.rs"] mod pkg;
#[path = "modules/mem.rs"] mod mem;
#[path = "modules/res.rs"] mod res;
#[path = "modules/shell.rs"] mod sh;
#[path = "modules/uptime.rs"] mod up;
#[path = "modules/kernel.rs"] mod kernel;
#[path = "modules/user.rs"] mod user;
